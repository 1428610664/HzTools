...
import hz.com.hztools.utils.RxDataTool;
import hz.com.hztools.utils.RxImageTool;
import hz.com.hztools.utils.RxKeyboardTool;

/**
 * Created by hz on 2018/1/16.
...
public class HzTitle extends FrameLayout{
    ...
    public HzTitle(Context context) {
        super(context);
    }

    public HzTitle(Context context, AttributeSet attrs) {
        super(context, attrs);
        //导入布局
    ...
    private void initView(final Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mTitleSize = a.getDimensionPixelSize(R.styleable.RxTitle_titleSize, RxImageTool.dip2px(18));//标题字体大小
            ...
            mLeftTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_leftTextSize, RxImageTool.dip2px(14));//标题字体大小
            ...
            mRightTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_rightTextSize, RxImageTool.dip2px(14));//标题字体大小
