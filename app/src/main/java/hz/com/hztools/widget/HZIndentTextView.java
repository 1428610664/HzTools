...
public class HZIndentTextView extends FrameLayout {
    ...
    public HZIndentTextView(Context context) {
        this(context, null);
    }
    public HZIndentTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public HZIndentTextView(Context context, AttributeSet attrs, int defStyleAttr) {
