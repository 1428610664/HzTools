...
/**
 * RecyclerView添加头部底部布局，无需修改adapter
 *
 * Created by pursuit on 2017/12/11.
 */

public class HZRecyclerView extends RecyclerView {
    ...
    public HZRecyclerView(Context context) {
        this(context, null);
    }
    public HZRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public HZRecyclerView(Context context, AttributeSet attrs, int defStyle) {
