...
public class HZDanmuView extends RelativeLayout {
    private int mWidth;
    ...
    private int mDelayDuration = 800;
        ...
        public void handleMessage(final Message msg) {
            ...
            animator.setListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    HZDanmuView.this.removeView(mChildList.get(pos));
    ...
    public HZDanmuView(Context context) {
        this(context, null, 0);
    }
    public HZDanmuView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public HZDanmuView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void switchAnimation(final XCAction action){
        ...
        HZDanmuView.this.startAnimation(animation);
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if(action == XCAction.HIDE){
                    HZDanmuView.this.setVisibility(View.GONE);
                }else{
                    HZDanmuView.this.setVisibility(View.VISIBLE);
                }
            }
            @Override
