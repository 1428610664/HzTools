...
public class IndicatorDialogActicity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indicator_dialog);
        initView();
        ...
        mLeftTop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showLeftDialog(v, 0.25f, IndicatorBuilder.GRAVITY_LEFT);
            }
        });
        ...
        IndicatorDialog dialog = new IndicatorBuilder(this)
                ...
                .adapter(new BaseAdapter() {
                    ...
                    public void onItemClick(View v, int position) {
                        Toast.makeText(IndicatorDialogActicity.this, "你点击了:" + position, Toast.LENGTH_SHORT).show();
                    }
